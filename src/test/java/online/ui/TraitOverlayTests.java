...
public final class TraitOverlayTests {
    public static void run() throws Exception {
        ...
        Check.that(before.contains("HP "+format(base.maxH)),"hold details show current HP stat");
        Check.that(before.contains("攻撃力 "+format(base.getAtk())),"hold details show current attack stat");
        Check.that(before.contains("移動速度 "+format(base.displayMoveSpeed())),"hold details show current movement stat");
        ...
        Check.equal(Math.round(base.maxH*4.5),boosted.maxH,"preview HP includes roulette Lv1 multiplier");
        Check.equal((int)Math.round(base.getAtk()*2.7),boosted.getAtk(),"preview attack includes roulette Lv1 multiplier");
        Check.equal(base.displayMoveSpeed()*1.5,boosted.displayMoveSpeed(),"preview speed includes roulette Lv1 multiplier");
