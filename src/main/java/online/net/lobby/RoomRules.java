...
public final class RoomRules {
    ...
    public static final RoomRules DEFAULT=new RoomRules(4400,0,-1,false,SpecialMode.CANNON);
    ...
    public RoomRules(int distance,int background,int music,boolean force60) {
        this(distance,background,music,force60,SpecialMode.CANNON);
    }
    public RoomRules(int distance,int background,int music,boolean force60,SpecialMode special) {
        ...
        castleDistance=distance;backgroundId=background;musicId=music;force60Fps=force60;specialMode=special;
    }
    public JsonObject json(){
        ...
        o.addProperty("specialMode",specialMode.name());
        return o;
    }
    ...
    @Override public boolean equals(Object value){
        ...
        return castleDistance==r.castleDistance&&backgroundId==r.backgroundId&&musicId==r.musicId
                &&force60Fps==r.force60Fps&&specialMode==r.specialMode;
    }
    @Override public int hashCode(){return Objects.hash(castleDistance,backgroundId,musicId,force60Fps,specialMode);}
}
