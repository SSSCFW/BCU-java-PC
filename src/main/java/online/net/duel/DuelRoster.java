...
public final class DuelRoster {
    ...
    public static DuelRoster read(JsonObject message) throws IOException {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            result.castleHealthMultiplier[i]=p.has("castleHealthMultiplier")?Protocol.real(p,"castleHealthMultiplier",0.1,1000.0):PvpStageBasis.DEFAULT_CASTLE_HEALTH_MULTIPLIER;
