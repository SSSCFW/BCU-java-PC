...
public final class Protocol {
    public static final int VERSION=11, TPS=30, INPUT_DELAY=3, HASH_INTERVAL=60, MAX_AHEAD=32;
    public static final int MAX_TEXT=4096, CHUNK=65536, MAX_FRAME=CHUNK+1024;
    public static final long MAX_BUNDLE=32L*1024*1024;
    public static final String ENGINE="bcu-pvp-11-native-shock-unit-hold";
    private Protocol() {}
