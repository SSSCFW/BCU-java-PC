...
public class JsonEncoder {
    private static final ThreadLocal<Map<Object,Object>> SCOPED_ALIASES = new ThreadLocal<>();

    /** Serialize a snapshot without changing editor objects (including borrowed default animations). */
    public static JsonElement encodeWithAliases(Object value, Map<Object,Object> aliases) {
        Map<Object,Object> previous = SCOPED_ALIASES.get();
        SCOPED_ALIASES.set(aliases);
        try { return encode(value); }
        finally { if (previous == null) SCOPED_ALIASES.remove(); else SCOPED_ALIASES.set(previous); }
    }
	...
	private static JsonElement encode(Object obj, JsonEncoder par) throws Exception {
        ...
        Map<Object,Object> aliases = SCOPED_ALIASES.get();
        if (aliases != null && aliases.containsKey(obj)) return encode(aliases.get(obj), par);
